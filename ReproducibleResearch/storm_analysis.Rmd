---
title: "Severe Weather Effects on Public Health and the Economy"
author: "Juan Jose"
...
*Note we assume you have downloaded the file and unzipped it to 'repdata-data-StormData.csv' and that you are executing this R script in the directory where the file is located.*
...
storm.data <- read.csv('repdata-data-StormData.csv', strip.white=TRUE)
names(storm.data)
...
The data set provides variables that can be used to answer the question of how weather events affect public health.
* FATALITIES
* INJURIES
...
The data set provides four variables that can be used to answer the question of how weather events affect the economy.
* PROPDMG
* PROPDMGEXP
* CROPDMG
* CROPDMGEXP
